  ...
  >
    ...
    <div className="flex flex-col gap-3">
      ...
      <p className="text-base leading-relaxed text-text/80">
        저의 모든 서비스는 하나의 <B>Virtual Machine</B>에서 동작하고 있습니다.
      </p>
      <p className="text-base leading-relaxed text-text/80">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-3">
              <span className="text-sm font-bold uppercase tracking-widest text-text/50">
                장점
              </span>
        ...
        {/* 인프라 다이어그램 */}
        <div className="border border-text/20 md:w-64 flex-none self-start">
          <img
            src={garageDiagram}
    ...
    <div className="flex flex-col gap-4">
      ...
      <p className="text-base leading-relaxed text-text/80">
        게이트웨이 뒷편에서는 <B>MySQL</B>, <B>Redis</B>와 같은 공용 인프라와 각
        서비스의 애플리케이션 서버들이 모두 <B>Docker</B> 컨테이너로 관리됩니다.
      </p>
      <p className="text-base leading-relaxed text-text/80">
      ...
      <p className="text-base leading-relaxed text-text/80">
        그리고 GitHub Actions는 VM이 GHCR에서 이미지를 <B>pull</B>받아 배포 중인
        이미지를 교체하도록 합니다.
      </p>
    </div>
  </div>
